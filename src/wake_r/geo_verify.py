...
来歴:
  ...
  v6  本版(サイクル11 残項目1の反映)。sector 繰込み補題(一般凸箱で反例 —
      ...
      方向補題が不要になり、上界値は v5 より小さい(66.5 vs 113 @K₀=20,τ=0)。
      正当性は包含連鎖「新包 ⊇ 真の合併 ∪𝒦」の直接論証による(旧 sector 被覆との
      包含関係には依存しない — スポット審査の指摘どおり新包 ⊉ 旧包)。
      スポット審査(2026-08-16)が連鎖5段・Steiner 係数・数値を独立再現し成立判定。
