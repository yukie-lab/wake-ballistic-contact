...
(a child re-marks its dead parent) produces a certified 4.4σ excess over the
branching bound; (B) that in the static limit the survival event coincides
...
が分枝上界を 4.4σ で超過することの数値確定、(B) 静的極限の生存事象がボンド希釈
